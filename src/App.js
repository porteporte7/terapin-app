    ...
    const App = () => {
        ...
        const handleSendMessage = async (e) => {
            ...
            try {
                ...
                // MODIFICACIÓN CLAVE AQUÍ: Leer la API Key de las variables de entorno
                const apiKey = process.env.REACT_APP_GEMINI_API_KEY || ""; // Obtener la clave de Netlify o dejar vacía para Canvas
